...
def movebase_client(x_goal,y_goal,theta_goal):
    ...
    if not wait:
        ...
        rospy.signal_shutdow("Action server no available!")
    else:
        #Success
...
if __name__ == '__main__':
    ...
    result = movebase_client(1.0, 9.0, 180.0)
    rospy.sleep(5)
    result = movebase_client(-2.5, 9.0, -90.0)
    rospy.sleep(5)
    result = movebase_client(-2.5, 5.0, 0.0)
    rospy.sleep(5)
    result = movebase_client(1.0, 5.0, 90.0)